...
<body class="login-layout">
											...
											<fieldset>
												...
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														...
														<span style="cursor:pointer"><img alt="验证码" src="drawCheckCode" onclick="reCheckcode(this)"/></span><!-- 鼠标变手指 -->
													</span>
												</label>
									...
									<div class="toolbar clearfix">
										<div>
											<a href="#" data-target="#forgot-box" class="forgot-password-link">
												<i class="ace-icon fa fa-arrow-left"></i>我忘记密码
											</a>
										</div>
										<div>
											<a href="#" data-target="#signup-box" class="user-signup-link">
												我要去注册<i class="ace-icon fa fa-arrow-right"></i>
											</a>
										</div>
									</div>
								</div><!-- /.widget-body -->
										...
										<form action="">
											<fieldset>
												...
												<div class="clearfix">
													...
													<button type="button" class="width-65 pull-right btn btn-sm btn-sucess">
	...
	<script type="text/javascript">
		window.jQuerey || document.write("<script src='<%=request.getContextPath()%>/resources/ace/assets/js/jquery.js'>" + "<" + "/script>");
	</script>
	<!-- <![endif]-->
	...
	<script type="text/javascript">
		...
		jQuery(function($){
			$('#btn-login-dark').on('click', function(e){
				...
				$('#id-compay-text').attr('class', 'blue');
			...
			$('#btn-login-blur').on('click', function(e){
				...
				$('#id-text2').attr('class', 'white');
				$('#id-compay-text').attr('class', 'light-blue');
